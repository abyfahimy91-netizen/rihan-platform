...
| مرتبط | ADR-001, ADR-002, ADR-003, ADR-007, اصل ۹, اصل ۱۰, D-022 (خودمیزبانی) |

> این سند پیش‌نویس است. تا تصویب ناظر، هیچ استقرار یا کانتینرسازی انجام نشود.
