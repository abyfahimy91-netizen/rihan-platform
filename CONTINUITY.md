...
3. ⏳ اولویت ۲: ADR-001 (Backend Framework) — **Proposed** — در انتظار مصوب‌سازی نهایی مشاور
4. 🔒 **قفل صریح:** شروع ADR-002 فقط پس از علامت‌گذاری ADR-001 به‌عنوان **Approved** توسط مشاور

### فاز ۴ (Software Planning) — IN PROGRESS

> ⚠️ **قفل ترتیبی (تصمیم مشاور ۱۴۰۵/۰۵/۱۵):**
> - تا مصوب شدن ADR-001، هیچ ADR دیگری شروع نمی‌شود
