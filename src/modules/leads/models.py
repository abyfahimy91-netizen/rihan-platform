...
class VisitorLead(models.Model):
    ...
    # D-126: هویت اتصال‌یافته (از واتساپ با کد یا از اعضا با DeviceToken)
    phone = models.CharField(max_length=15, blank=True, db_index=True, verbose_name='شماره تماس')
    name = models.CharField(max_length=100, blank=True, verbose_name='نام')
    link_code = models.CharField(max_length=8, blank=True, db_index=True, verbose_name='کد اتصال واتساپ')
